...
| الحزمة | التثبيت |
|---|---|
| [Riwaq_0.1.0_amd64.AppImage](Riwaq_0.1.0_amd64.AppImage) | `chmod +x Riwaq_0.1.0_amd64.AppImage && ./Riwaq_0.1.0_amd64.AppImage` |
| [Riwaq_0.1.0_amd64.deb](Riwaq_0.1.0_amd64.deb) | `sudo dpkg -i Riwaq_0.1.0_amd64.deb` |
| [Riwaq-0.1.0-1.x86_64.rpm](Riwaq-0.1.0-1.x86_64.rpm) | `sudo rpm -i Riwaq-0.1.0-1.x86_64.rpm` |
...
- **ثنائي اللغة**: عربي (RTL) وإنجليزي (LTR).
- **إجراءات الملف**: نافذة معلومات، فتح بالتطبيق الافتراضي، إظهار في مدير الملفات
...
- **File procedures**: properties dialog, open with default app, reveal in file manager
